...
<br></br>
 ...
 <xsl:template match="tei:listPerson">
        ...
        <xsl:for-each select="tei:person/tei:persName">
            ...
            <xsl:element name="div">
                <!-- assegna un class a listperson-entry -->
                ...
                <!-- prende xsl:for-each select tei:person/tei:persName-->
                <xsl:value-of select="."/>
                </xsl:element>
